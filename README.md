...
Open data/users.json in this repository
...
Also add the email and role to the STAFF object in data.js
The default password hash above corresponds to admin — the new staff member will be forced to change it on first login
...
Tom Otieno Email: t.otieno@ugandabiodiversityfund.org Role: Staff & System Developer

🏢 Organisation
Uganda Biodiversity Fund (UBF) Plot 425 Zzimwe Road, Kisugu, Kampala PO Box 26156, Kampala, Uganda Fixed Tel: +256-393-216-445 Email: info@ugandabiodiversityfund.org Website: www.ugandabiodiversityfund.org
